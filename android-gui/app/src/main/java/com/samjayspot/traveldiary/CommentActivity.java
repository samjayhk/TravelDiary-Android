...
public class CommentActivity extends SwipeBackActivity implements View.OnClickListener {
    ...
    ImageView btnClose;
    TextView btnSubmit, btnUpload, txtTitle, btnCamera;
    EditText edtContent;
    Uri outPutfileUri;
        ...
        switch (v.getId()) {
            ...
            case R.id.btnCommentComment:
                if (edtContent.getText().toString() != "") {
                    ...
                    Snackbar snackbar = Snackbar.make(commentLayout, "Please fill in comment!", Snackbar.LENGTH_SHORT);
                    View rootSnackbar = snackbar.getView();
                    rootSnackbar.setBackgroundColor(Color.RED);
                    snackbar.show();
                }
            ...
            case R.id.btnCamera:
                ...
                try {
                    outPutfileUri = b
                            ? FileProvider.getUriForFile(CommentActivity.this, authority, file)
                            : Uri.fromFile(file);
