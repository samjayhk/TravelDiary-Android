...
import static com.samjayspot.traveldiary.ThreadViewActivity.fromCharCode;
...
public class ListTabAdapter extends RecyclerView.Adapter<ListTabAdapter.ViewHolder> {
    ...
    public ListTabAdapter(ArrayList<Integer> pid, ArrayList<Integer> uid,
    ...
    @Override
    public ListTabAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_list, parent, false);
        return new ListTabAdapter.ViewHolder(view);
    }
    ...
    @Override
    public void onBindViewHolder(final ListTabAdapter.ViewHolder holder, final int position) {
        holder.txtSubject.setText(ascii2native(subject.get(position)));
